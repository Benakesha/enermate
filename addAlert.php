...
<html lang="en">
    ...
    <body style="font-family: 'Lato', sans-serif; font-size: 14px; color: #333; margin: 0px;  padding: 0px;  background: #eef1f5;"><br/><br/>
        ...
        <div class="container-fluid">
            <form class="form-alert" role="form" id="addAlert" action="alertphp.php" method="post" 
                        ...
                        <div class="panel padding-5">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alertName" id="aName" class="form-control" placeholder="Enter Event Name" autofocus="true"> 
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-fa-list">
                                        <div class="input-fa-radio">
                                            <input type="radio" name="atype" value="simple" id="at1">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-inline" style="height: 34px;" id="ddList" name="locationlist">
                                         ...
                                         <option label="PRODUCTION PANEL SMSB1" value="PRODUCTION PANEL SMSB1">PRODUCTION PANEL SMSB1</option>
                                         <option label="SMSB-3 TEST LAB" value="SMSB-3 TEST LAB">SMSB-3 TEST LAB</option>
                                         <option label="SMSB-2 OFFICE" value="SMSB-2 OFFICE">SMSB-2 OFFICE</option>
                                         <option label="A/C CONTROL GROUND FLOOR" value="A/C CONTROL GROUND FLOOR">A/C CONTROL GROUND FLOOR</option>
                                         <option label="AC PANEL TERRACE" value="AC PANEL TERRACE">AC PANEL TERRACE</option>
                                    </select>
                                </div>
                                <br>
                                <div class="form-group">
